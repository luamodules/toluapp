...
macro(LuaModuleImport LuaVersion ModuleName ModulePath ExePath)
    ...
    IF (WIN32)
        ...
        LUA_SUBDIRLIST(SUBDIRS ${CMAKE_CURRENT_SOURCE_DIR}/${ExePath})
        FOREACH(subdir ${SUBDIRS})
            FILE(GLOB_RECURSE DMMODULE_EXE_SOURCES
            ${CMAKE_CURRENT_SOURCE_DIR}/${ExePath}/${subdir}/*.cpp
            ${CMAKE_CURRENT_SOURCE_DIR}/${ExePath}/${subdir}/*.cc
